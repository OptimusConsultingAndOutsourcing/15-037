function applyCargaDocumentosTemplate($scope, Gateway) 
{
    ...
    $scope.actualizarRecaudo = function (fileInfo, piTipoModi, callback)
    {
        ...
        actualizarRecaudoSol.piNmArchivoOriginal.__text = fileInfo.doecNmArchivoOriginal;
        actualizarRecaudoSol.piDeFilesystem.__text = fileInfo.doecNmArchivoFs;
    ...
    $scope.duplicateFile = function(doc, file)
    {
        ...
        copy.doecNmArchivoOriginal = null;
